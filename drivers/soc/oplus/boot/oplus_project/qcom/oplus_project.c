...
static void init_project_version(void)
{
    ...
    pr_err("get_project:%d, is_new_cdt:%d, get_PCB_Version:%d, get_Oplus_Boot_Mode:%d, get_Modem_Version:%d\n", 
            ...
            get_Oplus_Boot_Mode(),
            get_Modem_Version());
    pr_err("get_Operator_Version:%d, get_dtsiNo:%d, get_audio_project:%d, get_Oplus_Boot_Mode:%d\n",
            get_Operator_Version(),
            get_dtsiNo(),
            get_audio());
#else
        pr_err("get_project:%d, is_new_cdt:%d, get_Modem_Version:%d\n",
            get_project(),
            is_new_cdt(),
            get_Modem_Version());
#endif
