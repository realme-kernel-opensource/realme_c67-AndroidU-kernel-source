...
struct smb_charger {
	...
	struct pinctrl		 *ntcswitch_pinctrl;
	...
	bool usb_btb_support;
	bool batt_btb_support;
	bool pa_thermal_support;
	bool batt_thermal_support;
	bool charger_thermal_support;
	bool quiet_thermal_support;
	bool bb_thermal_support;
	bool flash_thermal_support;
#endif
};
