...
static void oplus_otg_status_check_work(struct work_struct *work)
{
   ...
   if ((contion1 || contion2 || contion3 || contion4 || contion5) && (get_eng_version() != HIGH_TEMP_AGING)){ //Jichen.Pan@BSP.CHG.Basic,QE lab demands no temp protection in QE experiment
           otg_protect_cnt++;
